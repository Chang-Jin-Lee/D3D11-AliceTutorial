...
void App::OnUpdate(const float& dt)
{
	...
	float t1 = 1.5f * t0;   // 두번째 메쉬(자식1) Yaw 속도 (루트와 다르게)
	float t2 = 2.2f * t0;   // 세번째 메쉬(자식2) 공전 속도
...
bool App::InitEffect()
{
	...
	*/
	...
	HR_T(CompileShaderFromFile(L"04_TexVertexShader.hlsl", "main", "vs_4_0", &vertexShaderBuffer));
	...
	*/
	...
	HR_T(CompileShaderFromFile(L"04_TexPixelShader.hlsl", "main", "ps_4_0", &pixelShaderBuffer));
