...
공개 `SampleModel.glb` 한 캐릭터를 같은 카메라·포즈·조명 조건에서 `PBR`, `Hybrid Toon-PBR`, `Split`으로 비교하는 Direct3D 11 샘플입니다. 물리 기반 입력을 유지하면서 명암 면, 머리카락 하이라이트, 림 라이트, 외곽선을 아트 디렉션할 수 있도록 구성했습니다.
