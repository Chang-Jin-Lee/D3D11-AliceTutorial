...
bool App::OnInitialize()
{
	...
	if (ReadmeCapture::IsEnabled())
	{
		...
		{
			m_->m_Models[2]->pos = XMFLOAT3(0.0f, -2.0f, 85.0f);
			m_->m_Models[2]->scale = XMFLOAT3(1.5f, 1.0f, 5.0f);
		}
		if (m_->m_Models.size() > 3)
		{
			m_->m_Models[3]->pos = XMFLOAT3(0.0f, -3.0f, 120.0f);
			m_->m_Models[3]->scale = XMFLOAT3(1.5f, 1.0f, 5.0f);
		}
		m_Camera.SetPosition(XMFLOAT3(8.0f, 68.0f, -130.0f));
