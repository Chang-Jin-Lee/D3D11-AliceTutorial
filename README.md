...
| 36–40 | 통합 데모, 노드 UI 실험, 스타일라이즈드 셰이딩, 반투명 OIT, MSAA·A2C 비교 |

처음에는 번호 순서대로 실행하고, 각 README의 구현 내용과 실행 화면을 함께 보면 됩니다. 39번의 [반투명 레이스와 Weighted Blended OIT](Dx11/39_Transparency_OIT/README.md)에 이어, 40번에서는 [레이스 경계의 MSAA와 Alpha-to-Coverage](Dx11/40_MSAA_AlphaToCoverage/README.md)를 비교합니다.
