...
| stb_image | local copy from `dx11-math-shader` reference project | Decodes external and embedded PNG/JPG/TGA textures on the CPU for mip generation in `Common/Mesh/FbxMaterial.cpp`. |
