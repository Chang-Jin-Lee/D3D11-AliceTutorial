...
enum ImGuiSelectableFlags_
{
    ...
    ImGuiSelectableFlags_AllowItemOverlap = ImGuiSelectableFlags_AllowOverlap,          // Compatibility for existing samples. Renamed in 1.89.7.
#endif
};
...
namespace ImGui
{
    ...
    IMGUI_API void      SetItemAllowOverlap();                                                        // Compatibility for existing samples. Prefer SetNextItemAllowOverlap() _before_ item in new code.
