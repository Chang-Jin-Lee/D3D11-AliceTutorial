...
Assert-True ($body -match 'model\.scale\s*=\s*XMFLOAT3\(\s*0\.01f\s*,\s*0\.01f\s*,\s*0\.01f\s*\)') '0.01 startup scale missing'
...
Assert-True ($loadBlock -match 'model\.scale\s*=\s*XMFLOAT3\(\s*0\.01f\s*,\s*0\.01f\s*,\s*0\.01f\s*\)') '0.01 startup scale must be inside successful load block'
